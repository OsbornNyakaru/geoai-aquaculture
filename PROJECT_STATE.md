...
|---|---|---|
| `seq_a_xview` (legal, seed 42) | **0.889686** | ✅ the only scored legal artifact |
| `champion_archblend4` (legal) | — | ⏳ rebuild pending — was finalist #1 |
| `champion_seedavg5` (legal) | — | ⏳ rebuild pending |
