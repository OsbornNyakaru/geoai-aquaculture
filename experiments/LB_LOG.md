...
| 32 | 2026-07-29 | **SEED-CONFIRM permanence** + τ selection | champion_perm_seedavg5 / c_perm_wide | legal | **0.896918 / 0.898712** | ✅ **CONFIRMED: seed-avg 0.8969 = +0.010 vs champion seed-avg (~0.8865), seed noise removed.** ~0.005 of the single-seed 0.9016 was seed-42 luck. τ selection: 4-τ ≥ 6-τ (wide worse) — keep 4 |
